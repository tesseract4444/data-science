...
#print(xmas_tree_top_simple(0, 3))
#print(xmas_tree_top_simple(1, 3))
#print(xmas_tree_top_simple(2, 3))
#print(xmas_tree_stub(3))

print(xmas_tree_simple(5, 1))
#print(xmas_tree_simple(int(input('Höhe Baum: ')), int(input('Höhe Stamm: '))))